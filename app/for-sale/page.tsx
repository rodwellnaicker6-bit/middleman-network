...
const LISTINGS = [
  {
    ...
    badge: 'BOAT FOR SALE',
    badgeColor: '#0ea5e9',
    title: 'Vivacity 20 — 20ft Fully Rigged',
    price: 'R95,000',
    tag: 'Negotiable',
    location: 'Durban, KZN',
    condition: 'Excellent',
    specs: [
      'Vivacity 20 — 20ft (6.1m) fibreglass sailboat',
      'Capacity: 20 persons',
      'Full Bermudian sloop rig — all sails included',
      'Small outboard motor fitted',
      'Cuddy cabin — 2 berths',
      'Road-registered trailer included',
      'Full set of safety equipment',
      'Recently serviced — sails and rigging in great condition',
    ],
    whatsapp: `Hi, I'm interested in the Vivacity 20 sailboat (R95,000) listed on TMN. Can we chat?`,
  },
  {
    id: 'vr6-project',
    emoji: '🏎️',
